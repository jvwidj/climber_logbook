  ...
  return (
    <Container>
      ...
      <Col>
        ...
        <Row className="my-2">
          <Card>
            <Card.Body>
              <p>
                {grade} {type} at{" "}
                {/* Todo: Make dynamic. change type according to dropdown */}
                <br />
                {location_name}
              </p>
            </Card.Body>
          ...
          <Card>
            <Card.Body>
              <Col>
                ...
                {/* GRADE */}
                {type === "Bouldering" ? (
                  <GradeBouldering sendValue={(value) => setGrade(value)} />
                ) : type === "Sport" ? (
                  <GradeSport sendValue={(value) => setGrade(value)} />
                ) : (
        ...
        <Row className="my-2">
          <Card>
            <Card.Body>Upload Photo/Vid</Card.Body>
          </Card>
        </Row>
      </Col>
    </Container>
